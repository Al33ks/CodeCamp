...
namespace Kalkulator
{
    public partial class Form1 : Form
    {
        ...
        private void l7_Click(object sender, EventArgs e)
        {
            ...
            /*
             * W tej konkretnej linijce kodu autor chce upewnić się, że wartość w textBox_Result nie jest pusta (null), zanim dokona jakiejkolwiek operacji na tym tekście. Warunek textBox_Result.Text != null sprawdza, czy wartość nie jest pusta, a następnie połączenie go z textBox_Result.Text == "0" zapewnia, że wartość jest również równa "0". Jeśli oba warunki są spełnione, tekst w textBox_Result jest ustawiany na "7". W przeciwnym razie tekst jest dodawany do bieżącej wartości w textBox_Result.
             */
        }
